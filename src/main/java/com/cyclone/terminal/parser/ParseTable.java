...
{
    /**
     * The from and To are or'ed together in the following array, with the to being
     * left shifted by 4 bits before the or operation.
     *  
     *  State.From State.To Action.Action
     *  
     *  ANYWHERE, GROUND, EXECUTE, method()
     *
     *  NOTE: Yes, we use (0 << 4) in the code which could be replaced with 0 but
     *        the shift helps us remember what we are doing.
     *
